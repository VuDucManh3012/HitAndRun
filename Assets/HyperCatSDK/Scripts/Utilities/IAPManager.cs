...
#endif
{
    ...
    {
        AllProducts.Clear();
        AllProducts.Add(GameManager.Instance.NoAdsId, ProductType.NonConsumable);

        //Add more Product config here
    }
    ...
    public void RestorePurchases()
    {
            ...
            Application.platform == RuntimePlatform.OSXPlayer)
        {
            ...
            {
                HCDebug.Log("IAP >RestorePurchases continuing: " + result + ". If no further messages, no purchases available to restore.");
            });
        }
        else
        {
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        try
        {
            if (string.Equals(args.purchasedProduct.definition.id, GameManager.Instance.NoAdsId, StringComparison.Ordinal))
            {
                OnBuyNoAdsOffer();
            }
